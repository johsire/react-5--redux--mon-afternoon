    ...
    render(){
        ...
        return(
            <div className="parent-div">
                    ...
                    <div className="row">
                        <Link to="/wNine"><button value="Has never been in bankruptcy" onClick={ updateHistory(e.target.value) }>No</button></Link>
                        ...
                        <Link to="/wNine"><button value="Has had both a foreclosure and a bankruptcy" onClick={ updateHistory(e.target.value) }>Both</button></Link>
                    </div>
                </div>
            </div>
        )
